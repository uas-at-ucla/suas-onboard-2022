...
#         self.image_path_3 = '/app/images/test/alphanumeric-model-test2.jpg'
#         self.image_path_4 = '/app/images/test/alphanumeric-model-test3.jpg'
...
#         cv2.imwrite("/app/images/debug/test_crop_1.jpg", img_crop)
...
#         x1, y1, x2, y2 = int(x1), int(y1), int(x2), int(y2)
#         img_crop = img[y1:y2, x1:x2]
#         cv2.imwrite("/app/images/debug/test_crop_2.jpg", img_crop)
#         img = cv2.imread(self.image_path_3)
#         pred = self.model.detect_boxes(img)
#         x1, y1, x2, y2 = pred[0]
#         x1, y1, x2, y2 = int(x1), int(y1), int(x2), int(y2)
#         img_crop = img[y1:y2, x1:x2]
#         cv2.imwrite("/app/images/debug/test_crop_3.jpg", img_crop)
#         img = cv2.imread(self.image_path_4)
#         pred = self.model.detect_boxes(img)
#         x1, y1, x2, y2 = pred[0]
#         x1, y1, x2, y2 = int(x1), int(y1), int(x2), int(y2)
#         img_crop = img[y1:y2, x1:x2]
#         cv2.imwrite("/app/images/debug/test_crop_4.jpg", img_crop)
